...
void ArvoreAVL::Criar(ArvoreAVL &MinhaArvore)
{
...
int ArvoreAVL::Atribui_altura(No *N)
{
...
int ArvoreAVL::Calcula_balanceamento(No *N)
{
    if (N == NULL)
        return 0;
...
void ArvoreAVL::RotacaoEsquerda(No *&Raiz)
{
...
void ArvoreAVL::RotacaoDireita(No *&Raiz)
...
void ArvoreAVL::RealizarRotacao(No *&Raiz)
{
...
void ArvoreAVL::Inserir(No *&Raiz, int valor)
{
...
void ArvoreAVL::Imprime_ordem(No* noAtual){

if(noAtual!=NULL){
    Imprime_ordem(noAtual->esquerda);
    cout<<"Elemento visitado foi o "<<noAtual->info<<endl;
    Imprime_ordem(noAtual->direita);
...
arv.Inserir(arv.raiz,27);
arv.Inserir(arv.raiz,33);
arv.Inserir(arv.raiz,20);
arv.Inserir(arv.raiz,15);
